{
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        {
          "id": "5bf8f9f1-c34e-4608-a0d6-2a6464f5d6ee",
          "type": "basic.output",
          "data": {
            "name": "buttons",
            "range": "[7:0]",
        ...
        {
          "id": "8af3a604-e456-4702-b276-71c1f84f7178",
          "type": "basic.output",
          "data": {
            "name": "clk_nes",
            "pins": [
        ...
        {
          "id": "be59db15-ca4a-46a0-b547-c42a35eda32a",
          "type": "basic.input",
          "data": {
            "name": "data_nes",
            "pins": [
        ...
        {
          "id": "b128b393-0860-4240-b1f3-a9470d92df29",
          "type": "basic.output",
          "data": {
            "name": "strb_nes",
            "pins": [
        ...
        {
          "id": "5d5e12d7-d8cb-4e3d-9fe8-f5d2341d3221",
          "type": "basic.constant",
          "data": {
            "name": "Hz",
            "value": "83_000",
        ...
        {
          "id": "b3f94257-d547-4103-bdf3-4de0441cee3c",
      ...
      "wires": [
        {
          ...
          "target": {
            "block": "5bf8f9f1-c34e-4608-a0d6-2a6464f5d6ee",
            "port": "in"
          },
          "size": 8
        },
        {
          ...
          "target": {
            "block": "8af3a604-e456-4702-b276-71c1f84f7178",
            "port": "in"
          }
        },
        {
          ...
          "target": {
            "block": "b128b393-0860-4240-b1f3-a9470d92df29",
            "port": "in"
          }
        },
        {
          "source": {
            "block": "be59db15-ca4a-46a0-b547-c42a35eda32a",
            "port": "out"
          },
          "target": {
            "block": "83f0d3d9-63d0-4236-b3c2-42471a6c6fbd",
        ...
        {
          "source": {
            "block": "5d5e12d7-d8cb-4e3d-9fe8-f5d2341d3221",
            "port": "constant-out"
          },
          "target": {
            "block": "b3f94257-d547-4103-bdf3-4de0441cee3c",
